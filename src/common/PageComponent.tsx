...
function PageComponent({pageResponse}: Props): ReactElement | null { // 리턴 타입에 null 추가

    // 페이지가 없을 경우 컴포넌트 렌더링하지 않음
    if (pageResponse.totalPage === 0) return null;
    ...
    const next:boolean = endPage < pageResponse.totalPage; // 수정: next가 totalPage보다 작아야 true
